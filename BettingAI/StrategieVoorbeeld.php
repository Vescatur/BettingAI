...
function SpelerEenBeurtEen6_1($RandomGetal,$Hand) {
    if($Hand >= 4) {
...
function SpelerTweeBeurtEen6_1($RandomGetal,$Hand,$InzetSpelerEen) {
...
function SpelerEenBeurtTwee6_1($RandomGetal,$Hand,$InzetSpelerEen,$InzetSpelerTwee){
    return 0;
} 
